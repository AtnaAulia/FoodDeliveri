            ...
            <div class="mb-3">
                <label class="form-label">Status</label>
                    <select class="form-control" name="status" class="form-select" value="<?= $restaurants['status'] ?>">
                      <option value="Open" <?= $restaurants['status']=='Open'?'selected':'' ?>>Open</option>
                      <option value="Rest" <?= $restaurants['status']=='Rest'?'selected':'' ?>>Rest</option>
                      <option value="Close" <?= $restaurants['status']=='Close'?'selected':'' ?>>Close</option>
                    </select>
            </div>
